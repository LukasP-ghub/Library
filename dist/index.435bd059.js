...
class App extends _selectors.Selectors {
    constructor(){
        super();
        this._books = [];
    }
    ...
    setBooks(book1) {
        if (book1 instanceof _book.Book) return this._books.push(book1);
        let books = book1;
        if (Array.isArray(books) && books.length > 0) this._books = books.map(({ title , author , readPriority , category  })=>new _book.Book({
                title,
                author,
                readPriority,
                category
...
},{"./selectors":"85qvX","./book":"kIrhb"}],"85qvX":[function(require,module,exports) {
...
},{}],"kIrhb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Book {
    ...
    setAuthor(author1) {
        this._author = this.validateAuthor(author1);
    }
    setTitle(title1) {
        this._title = this.validateTitle(title1);
    }
    setReadPriority(readPriority1) {
        this._readPriority = this.validateReadPriority(Number(readPriority1));
    }
    setCategory(category1) {
        this._category = this.validateCategory(category1);
    }
    getAuthor() {
        return this._author;
    }
    ...
    validateAuthor(author2) {
        if (!author2) throw new Error('No author name');
        if (typeof author2 !== 'string') throw new Error('Wrong data type. String expected.');
        if (author2.length < 3) throw new Error('Author name is too short');
        return author2;
    }
    validateTitle(title2) {
        if (!title2) throw new Error('No title name');
        if (typeof title2 !== 'string') throw new Error('Wrong data type. String expected.');
        if (title2.length < 1) throw new Error('Title name is too short');
        return title2;
    }
    ...
    validateCategory(category2) {
        if (!category2) throw new Error('No category value.');
        if (typeof category2 !== 'string') throw new Error('Wrong data type. String expected.');
        return category2;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["hVNDP","dxxdW"], "dxxdW", "parcelRequire3c87")
